...
import { tub, unit, type SeedProduct } from "./builders";

/* Collection cover art */
const whirlpoolCover = "collection_section_images/whirlpool.jpg";
const saunaCover = "collection_section_images/sauna.jpg";
const poolsCover = "collection_section_images/pools.jpg";
const showersCover = "collection_section_images/showers.jpg";

/* Product photography */
const aquelHotSpa = "catalog_images/aquel-hot-spa.png";
const empress = "catalog_images/empress.png";
const owens6x6 = "catalog_images/owens-6x6.png";
const owens6x5 = "catalog_images/owens-6x5.png";
const supreme = "catalog_images/supreme.png";
const oplux = "catalog_images/oplux.png";
const triora = "catalog_images/triora.png";
const sublime = "catalog_images/sublime.png";
const atlanta = "catalog_images/atlanta.png";
const diana = "catalog_images/diana.png";
const vintage = "catalog_images/vintage.png";
const slate = "catalog_images/slate.png";
const slime = "catalog_images/slime.png";
const opel = "catalog_images/opel.png";
const taal = "catalog_images/taal.png";
const roman = "catalog_images/roman.png";
const lineaLux = "catalog_images/linea-lux.png";
const aquaNova = "catalog_images/aqua-nova.png";
const symphony = "catalog_images/symphony.png";
const focus = "catalog_images/focus.png";
const coral = "catalog_images/coral.png";
const silven = "catalog_images/silven.png";
const glamour = "catalog_images/glamour.png";
const splash = "catalog_images/splash.png";
const mist = "catalog_images/mist.png";
const breeze = "catalog_images/breeze.png";
const tulipe = "catalog_images/tulipe.png";
const explorer = "catalog_images/explorer.png";
const breeze2 = "catalog_images/breeze-2.png";
const baine = "catalog_images/baine.png";
const hydraLux = "catalog_images/hydra-lux.png";
const standelle = "catalog_images/standelle.jpeg";
const aquaLith = "catalog_images/aqua-lith.png";
const saunaRoom = "catalog_images/sauna-room.png";
const saunaBath4kw = "catalog_images/sauna-bath-4kw.png";
const steamCumSauna = "catalog_images/steam-cum-sauna.png";
const steamKq01 = "catalog_images/steam-kq01.png";
const steamKq06s = "catalog_images/steam-kq06s.png";
const steamKq006 = "catalog_images/steam-kq006.png";
const steamAq006s = "catalog_images/steam-aq006s.png";
const steamKq002 = "catalog_images/steam-kq002.png";
const steamKq004 = "catalog_images/steam-kq004.png";
const plunge = "catalog_images/plunge.webp";

/* Accessories */
const whirlpoolPump = "bathtub_accesories/whirlpool-pump.png";
const whirlpoolJet = "bathtub_accesories/whirlpool-jet.png";
const spineJetImg = "bathtub_accesories/spine-jet.png";
const airBlower = "bathtub_accesories/air-blower.png";
const controlPanel = "bathtub_accesories/control-panel.png";
const diverterSet = "bathtub_accesories/diverter-set.png";
const mixingValve = "bathtub_accesories/mixing-valve.png";
...
type CategoryListing = Omit<SeedCategory, "editorial"> & { index: string };
...
const WHIRLPOOL_TUBS: SeedProduct[] = [
  /* Double seater */
  tub({
...
/* Every piece, photographed or not. The seed publishes the ones with a
   photograph and saves the rest for when theirs arrives. */
export const CATEGORIES: SeedCategory[] = ALL_CATEGORIES.map((category) => {
  const editorial = COLLECTION_COPY[category.slug];
  if (!editorial) throw new Error(`No editorial copy for "${category.slug}"`);
  const { index: _index, ...rest } = category;
  void _index;
  return { ...rest, editorial };
});
